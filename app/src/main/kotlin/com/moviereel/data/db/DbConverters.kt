...
object DbConverters {
    ...
    @JvmStatic
    @TypeConverter
    fun fromString(value: String): ArrayList<MovieNPEntity> {
        val listType = object : TypeToken<ArrayList<MovieNPEntity>>() {}.type
    ...
    @JvmStatic
    @TypeConverter
    fun fromArrayList(arrayList: ArrayList<MovieNPEntity>): String {
        val gson = Gson()
