...
object DbConverters {
    ...
    @JvmStatic
    @TypeConverter
    fun fromString(value: String): ArrayList<MovieNowPlayingEntity> {
        val listType = object : TypeToken<ArrayList<MovieNowPlayingEntity>>() {}.type
    ...
    @JvmStatic
    @TypeConverter
    fun fromArrayList(arrayList: ArrayList<MovieNowPlayingEntity>): String {
        val gson = Gson()
