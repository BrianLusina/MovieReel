 ...
 * @Notes Representation for a [MovieNowPlayingDataEntity] fetched from an external layer data source
 */
data class MovieNowPlayingDataEntity(var id: Long, var voteCount: Int, var video: Boolean, var voteAverage: Float,
